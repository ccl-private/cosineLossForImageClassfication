...
parser.add_argument('--train_url', default='.', type=str,
                    help='output path')
parser.add_argument('--data_url', default='/data/ccl/RP2K_rp2k_dataset/all/train_augmented_small/', type=str)
...
if __name__ == "__main__":
    ...
    ckp_cb = ModelCheckpoint(directory="/home/ccl/Documents/codes/python/minds/models/research/cv/arcface/output2/")

    model.train(train_epoch, train_dataset, callbacks=[stop_cb, ckp_cb], dataset_sink_mode=True)
    if args.modelarts:
        mox.file.copy_parallel(
